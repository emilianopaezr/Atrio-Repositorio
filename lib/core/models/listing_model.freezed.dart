...
/// Create a copy of Listing
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? hostId = null,Object? type = null,Object? title = null,Object? description = freezed,Object? images = null,Object? category = freezed,Object? tags = null,Object? amenities = null,Object? rules = null,Object? address = freezed,Object? city = freezed,Object? country = freezed,Object? latitude = freezed,Object? longitude = freezed,Object? basePrice = freezed,Object? currency = null,Object? priceUnit = null,Object? cleaningFee = null,Object? capacity = freezed,Object? status = null,Object? rating = null,Object? reviewCount = null,Object? viewCount = null,Object? isFeatured = null,Object? rentalMode = null,Object? availableDays = null,Object? availableFrom = freezed,Object? availableUntil = freezed,Object? minHours = null,Object? maxHours = null,Object? minNights = null,Object? maxNights = null,Object? slotDurationMinutes = null,Object? blockHours = null,Object? maxCapacity = freezed,Object? instantBooking = null,Object? checkInTime = freezed,Object? checkOutTime = freezed,Object? cancellationPolicy = null,Object? hostPhone = freezed,Object? showHostPhone = null,Object? createdAt = freezed,Object? updatedAt = freezed,Object? hostData = freezed,Object? distanceM = freezed,}) {
...
as String,hostPhone: freezed == hostPhone ? _self.hostPhone : hostPhone // ignore: cast_nullable_to_non_nullable
as String?,showHostPhone: null == showHostPhone ? _self.showHostPhone : showHostPhone // ignore: cast_nullable_to_non_nullable
...
as Map<String, dynamic>?,distanceM: freezed == distanceM ? _self.distanceM : distanceM // ignore: cast_nullable_to_non_nullable
as double?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'host_id')  String hostId,  String type,  String title,  String? description,  List<String> images,  String? category,  List<String> tags,  List<String> amenities,  List<String> rules,  String? address,  String? city,  String? country,  double? latitude,  double? longitude, @JsonKey(name: 'base_price')  double? basePrice,  String currency, @JsonKey(name: 'price_unit')  String priceUnit, @JsonKey(name: 'cleaning_fee')  double cleaningFee,  int? capacity,  String status,  double rating, @JsonKey(name: 'review_count')  int reviewCount, @JsonKey(name: 'view_count')  int viewCount, @JsonKey(name: 'is_featured')  bool isFeatured, @JsonKey(name: 'rental_mode')  String rentalMode, @JsonKey(name: 'available_days')  List<int> availableDays, @JsonKey(name: 'available_from')  String? availableFrom, @JsonKey(name: 'available_until')  String? availableUntil, @JsonKey(name: 'min_hours')  int minHours, @JsonKey(name: 'max_hours')  int maxHours, @JsonKey(name: 'min_nights')  int minNights, @JsonKey(name: 'max_nights')  int maxNights, @JsonKey(name: 'slot_duration_minutes')  int slotDurationMinutes, @JsonKey(name: 'block_hours')  int blockHours, @JsonKey(name: 'max_capacity')  int? maxCapacity, @JsonKey(name: 'instant_booking')  bool instantBooking, @JsonKey(name: 'check_in_time')  String? checkInTime, @JsonKey(name: 'check_out_time')  String? checkOutTime, @JsonKey(name: 'cancellation_policy')  String cancellationPolicy, @JsonKey(name: 'host_phone')  String? hostPhone, @JsonKey(name: 'show_host_phone')  bool showHostPhone, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt, @JsonKey(name: 'host')  Map<String, dynamic>? hostData, @JsonKey(name: 'distance_m')  double? distanceM)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Listing() when $default != null:
return $default(_that.id,_that.hostId,_that.type,_that.title,_that.description,_that.images,_that.category,_that.tags,_that.amenities,_that.rules,_that.address,_that.city,_that.country,_that.latitude,_that.longitude,_that.basePrice,_that.currency,_that.priceUnit,_that.cleaningFee,_that.capacity,_that.status,_that.rating,_that.reviewCount,_that.viewCount,_that.isFeatured,_that.rentalMode,_that.availableDays,_that.availableFrom,_that.availableUntil,_that.minHours,_that.maxHours,_that.minNights,_that.maxNights,_that.slotDurationMinutes,_that.blockHours,_that.maxCapacity,_that.instantBooking,_that.checkInTime,_that.checkOutTime,_that.cancellationPolicy,_that.hostPhone,_that.showHostPhone,_that.createdAt,_that.updatedAt,_that.hostData,_that.distanceM);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'host_id')  String hostId,  String type,  String title,  String? description,  List<String> images,  String? category,  List<String> tags,  List<String> amenities,  List<String> rules,  String? address,  String? city,  String? country,  double? latitude,  double? longitude, @JsonKey(name: 'base_price')  double? basePrice,  String currency, @JsonKey(name: 'price_unit')  String priceUnit, @JsonKey(name: 'cleaning_fee')  double cleaningFee,  int? capacity,  String status,  double rating, @JsonKey(name: 'review_count')  int reviewCount, @JsonKey(name: 'view_count')  int viewCount, @JsonKey(name: 'is_featured')  bool isFeatured, @JsonKey(name: 'rental_mode')  String rentalMode, @JsonKey(name: 'available_days')  List<int> availableDays, @JsonKey(name: 'available_from')  String? availableFrom, @JsonKey(name: 'available_until')  String? availableUntil, @JsonKey(name: 'min_hours')  int minHours, @JsonKey(name: 'max_hours')  int maxHours, @JsonKey(name: 'min_nights')  int minNights, @JsonKey(name: 'max_nights')  int maxNights, @JsonKey(name: 'slot_duration_minutes')  int slotDurationMinutes, @JsonKey(name: 'block_hours')  int blockHours, @JsonKey(name: 'max_capacity')  int? maxCapacity, @JsonKey(name: 'instant_booking')  bool instantBooking, @JsonKey(name: 'check_in_time')  String? checkInTime, @JsonKey(name: 'check_out_time')  String? checkOutTime, @JsonKey(name: 'cancellation_policy')  String cancellationPolicy, @JsonKey(name: 'host_phone')  String? hostPhone, @JsonKey(name: 'show_host_phone')  bool showHostPhone, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt, @JsonKey(name: 'host')  Map<String, dynamic>? hostData, @JsonKey(name: 'distance_m')  double? distanceM)  $default,) {final _that = this;
switch (_that) {
case _Listing():
return $default(_that.id,_that.hostId,_that.type,_that.title,_that.description,_that.images,_that.category,_that.tags,_that.amenities,_that.rules,_that.address,_that.city,_that.country,_that.latitude,_that.longitude,_that.basePrice,_that.currency,_that.priceUnit,_that.cleaningFee,_that.capacity,_that.status,_that.rating,_that.reviewCount,_that.viewCount,_that.isFeatured,_that.rentalMode,_that.availableDays,_that.availableFrom,_that.availableUntil,_that.minHours,_that.maxHours,_that.minNights,_that.maxNights,_that.slotDurationMinutes,_that.blockHours,_that.maxCapacity,_that.instantBooking,_that.checkInTime,_that.checkOutTime,_that.cancellationPolicy,_that.hostPhone,_that.showHostPhone,_that.createdAt,_that.updatedAt,_that.hostData,_that.distanceM);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'host_id')  String hostId,  String type,  String title,  String? description,  List<String> images,  String? category,  List<String> tags,  List<String> amenities,  List<String> rules,  String? address,  String? city,  String? country,  double? latitude,  double? longitude, @JsonKey(name: 'base_price')  double? basePrice,  String currency, @JsonKey(name: 'price_unit')  String priceUnit, @JsonKey(name: 'cleaning_fee')  double cleaningFee,  int? capacity,  String status,  double rating, @JsonKey(name: 'review_count')  int reviewCount, @JsonKey(name: 'view_count')  int viewCount, @JsonKey(name: 'is_featured')  bool isFeatured, @JsonKey(name: 'rental_mode')  String rentalMode, @JsonKey(name: 'available_days')  List<int> availableDays, @JsonKey(name: 'available_from')  String? availableFrom, @JsonKey(name: 'available_until')  String? availableUntil, @JsonKey(name: 'min_hours')  int minHours, @JsonKey(name: 'max_hours')  int maxHours, @JsonKey(name: 'min_nights')  int minNights, @JsonKey(name: 'max_nights')  int maxNights, @JsonKey(name: 'slot_duration_minutes')  int slotDurationMinutes, @JsonKey(name: 'block_hours')  int blockHours, @JsonKey(name: 'max_capacity')  int? maxCapacity, @JsonKey(name: 'instant_booking')  bool instantBooking, @JsonKey(name: 'check_in_time')  String? checkInTime, @JsonKey(name: 'check_out_time')  String? checkOutTime, @JsonKey(name: 'cancellation_policy')  String cancellationPolicy, @JsonKey(name: 'host_phone')  String? hostPhone, @JsonKey(name: 'show_host_phone')  bool showHostPhone, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt, @JsonKey(name: 'host')  Map<String, dynamic>? hostData, @JsonKey(name: 'distance_m')  double? distanceM)?  $default,) {final _that = this;
switch (_that) {
case _Listing() when $default != null:
return $default(_that.id,_that.hostId,_that.type,_that.title,_that.description,_that.images,_that.category,_that.tags,_that.amenities,_that.rules,_that.address,_that.city,_that.country,_that.latitude,_that.longitude,_that.basePrice,_that.currency,_that.priceUnit,_that.cleaningFee,_that.capacity,_that.status,_that.rating,_that.reviewCount,_that.viewCount,_that.isFeatured,_that.rentalMode,_that.availableDays,_that.availableFrom,_that.availableUntil,_that.minHours,_that.maxHours,_that.minNights,_that.maxNights,_that.slotDurationMinutes,_that.blockHours,_that.maxCapacity,_that.instantBooking,_that.checkInTime,_that.checkOutTime,_that.cancellationPolicy,_that.hostPhone,_that.showHostPhone,_that.createdAt,_that.updatedAt,_that.hostData,_that.distanceM);case _:
  return null;
...
@override@JsonKey(name: 'host_phone') final  String? hostPhone;
@override@JsonKey(name: 'show_host_phone') final  bool showHostPhone;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Listing&&(identical(other.id, id) || other.id == id)&&(identical(other.hostId, hostId) || other.hostId == hostId)&&(identical(other.type, type) || other.type == type)&&(identical(other.title, title) || other.title == title)&&(identical(other.description, description) || other.description == description)&&const DeepCollectionEquality().equals(other._images, _images)&&(identical(other.category, category) || other.category == category)&&const DeepCollectionEquality().equals(other._tags, _tags)&&const DeepCollectionEquality().equals(other._amenities, _amenities)&&const DeepCollectionEquality().equals(other._rules, _rules)&&(identical(other.address, address) || other.address == address)&&(identical(other.city, city) || other.city == city)&&(identical(other.country, country) || other.country == country)&&(identical(other.latitude, latitude) || other.latitude == latitude)&&(identical(other.longitude, longitude) || other.longitude == longitude)&&(identical(other.basePrice, basePrice) || other.basePrice == basePrice)&&(identical(other.currency, currency) || other.currency == currency)&&(identical(other.priceUnit, priceUnit) || other.priceUnit == priceUnit)&&(identical(other.cleaningFee, cleaningFee) || other.cleaningFee == cleaningFee)&&(identical(other.capacity, capacity) || other.capacity == capacity)&&(identical(other.status, status) || other.status == status)&&(identical(other.rating, rating) || other.rating == rating)&&(identical(other.reviewCount, reviewCount) || other.reviewCount == reviewCount)&&(identical(other.viewCount, viewCount) || other.viewCount == viewCount)&&(identical(other.isFeatured, isFeatured) || other.isFeatured == isFeatured)&&(identical(other.rentalMode, rentalMode) || other.rentalMode == rentalMode)&&const DeepCollectionEquality().equals(other._availableDays, _availableDays)&&(identical(other.availableFrom, availableFrom) || other.availableFrom == availableFrom)&&(identical(other.availableUntil, availableUntil) || other.availableUntil == availableUntil)&&(identical(other.minHours, minHours) || other.minHours == minHours)&&(identical(other.maxHours, maxHours) || other.maxHours == maxHours)&&(identical(other.minNights, minNights) || other.minNights == minNights)&&(identical(other.maxNights, maxNights) || other.maxNights == maxNights)&&(identical(other.slotDurationMinutes, slotDurationMinutes) || other.slotDurationMinutes == slotDurationMinutes)&&(identical(other.blockHours, blockHours) || other.blockHours == blockHours)&&(identical(other.maxCapacity, maxCapacity) || other.maxCapacity == maxCapacity)&&(identical(other.instantBooking, instantBooking) || other.instantBooking == instantBooking)&&(identical(other.checkInTime, checkInTime) || other.checkInTime == checkInTime)&&(identical(other.checkOutTime, checkOutTime) || other.checkOutTime == checkOutTime)&&(identical(other.cancellationPolicy, cancellationPolicy) || other.cancellationPolicy == cancellationPolicy)&&(identical(other.hostPhone, hostPhone) || other.hostPhone == hostPhone)&&(identical(other.showHostPhone, showHostPhone) || other.showHostPhone == showHostPhone)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&const DeepCollectionEquality().equals(other._hostData, _hostData)&&(identical(other.distanceM, distanceM) || other.distanceM == distanceM));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,hostId,type,title,description,const DeepCollectionEquality().hash(_images),category,const DeepCollectionEquality().hash(_tags),const DeepCollectionEquality().hash(_amenities),const DeepCollectionEquality().hash(_rules),address,city,country,latitude,longitude,basePrice,currency,priceUnit,cleaningFee,capacity,status,rating,reviewCount,viewCount,isFeatured,rentalMode,const DeepCollectionEquality().hash(_availableDays),availableFrom,availableUntil,minHours,maxHours,minNights,maxNights,slotDurationMinutes,blockHours,maxCapacity,instantBooking,checkInTime,checkOutTime,cancellationPolicy,hostPhone,showHostPhone,createdAt,updatedAt,const DeepCollectionEquality().hash(_hostData),distanceM]);
