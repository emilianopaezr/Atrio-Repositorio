...
mixin _$Booking {
 ...
 String get id;@JsonKey(name: 'guest_id') String get guestId;@JsonKey(name: 'host_id') String get hostId;@JsonKey(name: 'listing_id') String get listingId;@JsonKey(name: 'check_in') DateTime get checkIn;@JsonKey(name: 'check_out') DateTime get checkOut;@JsonKey(name: 'guests_count') int get guestsCount;@JsonKey(name: 'base_total') double? get baseTotal;@JsonKey(name: 'cleaning_fee') double get cleaningFee;@JsonKey(name: 'service_fee') double get serviceFee; double? get total; String get status;@JsonKey(name: 'payment_status') String get paymentStatus;@JsonKey(name: 'special_requests') String? get specialRequests;@JsonKey(name: 'conversation_id') String? get conversationId;// V2: Booking system fields
@JsonKey(name: 'rental_mode') String get rentalMode;@JsonKey(name: 'time_slots') List<dynamic> get timeSlots;@JsonKey(name: 'booking_date') String? get bookingDate;@JsonKey(name: 'start_time') String? get startTime;@JsonKey(name: 'end_time') String? get endTime;@JsonKey(name: 'duration_hours') double? get durationHours;@JsonKey(name: 'created_at') DateTime? get createdAt;@JsonKey(name: 'updated_at') DateTime? get updatedAt;// Joined data
...
/// Create a copy of Booking
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? guestId = null,Object? hostId = null,Object? listingId = null,Object? checkIn = null,Object? checkOut = null,Object? guestsCount = null,Object? baseTotal = freezed,Object? cleaningFee = null,Object? serviceFee = null,Object? total = freezed,Object? status = null,Object? paymentStatus = null,Object? specialRequests = freezed,Object? conversationId = freezed,Object? rentalMode = null,Object? timeSlots = null,Object? bookingDate = freezed,Object? startTime = freezed,Object? endTime = freezed,Object? durationHours = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? listingData = freezed,Object? guestData = freezed,Object? hostProfileData = freezed,}) {
...
as String?,rentalMode: null == rentalMode ? _self.rentalMode : rentalMode // ignore: cast_nullable_to_non_nullable
as String,timeSlots: null == timeSlots ? _self.timeSlots : timeSlots // ignore: cast_nullable_to_non_nullable
as List<dynamic>,bookingDate: freezed == bookingDate ? _self.bookingDate : bookingDate // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Booking() when $default != null:
return $default(_that.id,_that.guestId,_that.hostId,_that.listingId,_that.checkIn,_that.checkOut,_that.guestsCount,_that.baseTotal,_that.cleaningFee,_that.serviceFee,_that.total,_that.status,_that.paymentStatus,_that.specialRequests,_that.conversationId,_that.rentalMode,_that.timeSlots,_that.bookingDate,_that.startTime,_that.endTime,_that.durationHours,_that.createdAt,_that.updatedAt,_that.listingData,_that.guestData,_that.hostProfileData);case _:
  return orElse();
...
@override@JsonKey(name: 'time_slots') List<dynamic> get timeSlots {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Booking&&(identical(other.id, id) || other.id == id)&&(identical(other.guestId, guestId) || other.guestId == guestId)&&(identical(other.hostId, hostId) || other.hostId == hostId)&&(identical(other.listingId, listingId) || other.listingId == listingId)&&(identical(other.checkIn, checkIn) || other.checkIn == checkIn)&&(identical(other.checkOut, checkOut) || other.checkOut == checkOut)&&(identical(other.guestsCount, guestsCount) || other.guestsCount == guestsCount)&&(identical(other.baseTotal, baseTotal) || other.baseTotal == baseTotal)&&(identical(other.cleaningFee, cleaningFee) || other.cleaningFee == cleaningFee)&&(identical(other.serviceFee, serviceFee) || other.serviceFee == serviceFee)&&(identical(other.total, total) || other.total == total)&&(identical(other.status, status) || other.status == status)&&(identical(other.paymentStatus, paymentStatus) || other.paymentStatus == paymentStatus)&&(identical(other.specialRequests, specialRequests) || other.specialRequests == specialRequests)&&(identical(other.conversationId, conversationId) || other.conversationId == conversationId)&&(identical(other.rentalMode, rentalMode) || other.rentalMode == rentalMode)&&const DeepCollectionEquality().equals(other._timeSlots, _timeSlots)&&(identical(other.bookingDate, bookingDate) || other.bookingDate == bookingDate)&&(identical(other.startTime, startTime) || other.startTime == startTime)&&(identical(other.endTime, endTime) || other.endTime == endTime)&&(identical(other.durationHours, durationHours) || other.durationHours == durationHours)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&const DeepCollectionEquality().equals(other._listingData, _listingData)&&const DeepCollectionEquality().equals(other._guestData, _guestData)&&const DeepCollectionEquality().equals(other._hostProfileData, _hostProfileData));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,guestId,hostId,listingId,checkIn,checkOut,guestsCount,baseTotal,cleaningFee,serviceFee,total,status,paymentStatus,specialRequests,conversationId,rentalMode,const DeepCollectionEquality().hash(_timeSlots),bookingDate,startTime,endTime,durationHours,createdAt,updatedAt,const DeepCollectionEquality().hash(_listingData),const DeepCollectionEquality().hash(_guestData),const DeepCollectionEquality().hash(_hostProfileData)]);
